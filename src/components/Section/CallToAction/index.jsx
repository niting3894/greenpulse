...
export default function CallToAction() {
  return (
    <section className="py-16 px-4 sm:px-6 md:px-12 bg-[#f9f7f2]">
      <FadeUpSection>
        <div
          className="relative bg-fixed bg-center bg-cover bg-no-repeat rounded-2xl overflow-hidden h-[400px] sm:h-[550px] md:h-[600px] max-w-7xl mx-auto flex items-center justify-center text-center"
        ...
        >
          ...
          <div className="relative z-20 text-white px-4 sm:px-6 md:px-10 max-w-6xl">
            ...
            <h2 className="text-2xl sm:text-4xl md:text-7xl font-bold leading-snug mb-16">
              Ready to Embrace Sustainability <br className="hidden sm:block" />{" "}
