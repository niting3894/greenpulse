    ...
    <FadeUpSection>
      <div className="bg-[#f8eee6] rounded-2xl overflow-hidden transition-all duration-300 group">
          ...
          <div className="p-5 pb-2 sm:pb-4 sm:py-8 relative">
            ...
            {/* Read More Button */}
            <div
              className="mt-3 opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500 text-right"
            >
              <Link href="/blog/detail" className="text-sm text-[#69cf3d] transition-all">
                Read More →
              </Link>
            </div>
          </div>
